...
func Initialize() {
  ...
  //Gebaeude Team 1
  CreateConstruction(LCTR,390,270,-1,100,1);
  CreateConstruction(CTW0,225,270,-1,100,1);
  pStartHut1 = CreateConstruction(LBSE,75,270,-1,100,1);  
  Enter(pStartHut1,CreateObject(BALN));
  //Gebaeude Team 2
  CreateConstruction(LCTR,1050,270,-1,100,1);
  CreateConstruction(CTW0,1245,270,-1,100,1);
  pStartHut2 = CreateConstruction(LBSE,1395,270,-1,100,1);
